...
public class Add_fees extends javax.swing.JFrame {
    ...
    String student_name, rollno, course, courseyear, course1;
    ...
    public Add_fees() {
        ...
        setTableRecords();
        setCourse();
        text_receiptno.setText(Integer.toString(setReceiptNo()));
    ...
    public int validation() {
        if (text_rollno.getText().equals("")) {
            JOptionPane.showMessageDialog(this, "Please Hit Enter After Entering Student Name");
            return 1;
        }
        if (combo_payment.getSelectedItem().toString().equalsIgnoreCase("Online/Bank")) {
            ...
            return 1;
        } else if (text_1year.getText().equals("") || text_1stamount.getText().matches("[0-9]+") == false) {
            JOptionPane.showMessageDialog(this, "Please Enter Payment Year From");
            return 1;
        } else if (text_2year.getText().equals("") || text_1stamount.getText().matches("[0-9]+") == false) {
    ...
    public void setAmount() {
        try {
            ...
            String sql = "select course_price from course where course_name = ?";
            ...
            while (rs.next()) {
                String courseprice = rs.getString("course_price");
                text_1stamount.setText(courseprice);
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public void insertData() {
        ...
        String receipt_no, student_name, rollno, course, courseyear, paymentmode, transaction, card, cheque, bank_name, receivedfrom, year1, year2, amount, totalamount, gst, totalinwords, remarks;

        receipt_no = text_receiptno.getText();
        //date = text_date.getText();
        student_name = text_student.getText();
        ...
        totalinwords = text_totalwords.getText();
        ...
        try {
            ...
            Class.forName("com.mysql.cj.jdbc.Driver");
            java.sql.Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/fees_management_system", "Devesh", "Admin123");
            String sql = "insert into fees_record values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
            PreparedStatement stmt = con.prepareStatement(sql);
            ...
            stmt.setString(6, courseyear);
            stmt.setString(7, paymentmode);
            stmt.setString(8, transaction);
            stmt.setString(9, card);
            stmt.setString(10, cheque);
            stmt.setString(11, bank_name);
            stmt.setString(12, receivedfrom);
            stmt.setString(13, year1);
            stmt.setString(14, year2);
            stmt.setString(15, amount);
            stmt.setString(16, totalamount);
            stmt.setString(17, gst);
            stmt.setString(18, totalinwords);
    ...
    public int getStudentRecord() {
        try {
            ...
            Class.forName("com.mysql.cj.jdbc.Driver");
            java.sql.Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/fees_management_system", "Devesh", "Admin123");
            String sql = "select *from student_records where Student_Name = ?";
            PreparedStatement stmt = con.prepareStatement(sql);
            ...
            String rollno, course, courseyear, receipt, studentname;
    ...
    public void diplayTableRecords() throws SQLException {
        while (rs.next()) {
            ...
            Object[] obj = {rollno, student_name, course, courseyear};
            Model = (DefaultTableModel) table_records.getModel();
            Model.addRow(obj);
    ...
    private void initComponents() {
        ...
        Reciept3 = new javax.swing.JLabel();
        Reciept4 = new javax.swing.JLabel();
        Reciept11 = new javax.swing.JLabel();
        ...
        Reciept7.setForeground(new java.awt.Color(255, 255, 255));
        Reciept7.setText("Enrollment No :");

        Reciept3.setFont(new java.awt.Font("Georgia", 0, 24)); // NOI18N
        Reciept3.setForeground(new java.awt.Color(255, 255, 255));
        Reciept3.setText("Course :");

        Reciept4.setFont(new java.awt.Font("Georgia", 0, 24)); // NOI18N
        Reciept4.setForeground(new java.awt.Color(255, 255, 255));
        Reciept4.setText("Course Year :");

        Reciept11.setFont(new java.awt.Font("Georgia", 0, 24)); // NOI18N
        Reciept11.setForeground(new java.awt.Color(255, 255, 255));
        Reciept11.setText("Transaction I.D:");
        ...
        panel_parent.add(Reciept5, new org.netbeans.lib.awtextra.AbsoluteConstraints(900, 170, -1, -1));
        ...
        panel_parent.add(Reciept10, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 300, -1, -1));
        ...
        panel_parent.add(Reciept6, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 350, -1, -1));
        ...
        panel_parent.add(lbl_cardno, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 400, -1, -1));
        ...
        panel_parent.add(lbl_chequeno, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 400, -1, -1));

        text_receiptno.setEditable(false);
        text_receiptno.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        panel_parent.add(text_receiptno, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 130, 130, -1));
        ...
        panel_parent.add(text_rollno, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 190, 290, -1));
        ...
        panel_parent.add(combo_payment, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 350, 165, 28));
        ...
        panel_parent.add(Reciept, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 130, -1, -1));

        Panel_child.setBackground(new java.awt.Color(51, 51, 51));
        Panel_child.setFont(new java.awt.Font("Georgia", 1, 18)); // NOI18N

        Reciept14.setFont(new java.awt.Font("Georgia", 0, 36)); // NOI18N
        ...
        Reciept18.setFont(new java.awt.Font("Georgia", 0, 36)); // NOI18N
        Reciept18.setForeground(new java.awt.Color(255, 255, 255));
        Reciept18.setText("Amount:");
        ...
        Panel_childLayout.setVerticalGroup(
            ...
            .addGroup(Panel_childLayout.createSequentialGroup()
                ...
                .addGroup(Panel_childLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(Reciept18, javax.swing.GroupLayout.PREFERRED_SIZE, 52, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        panel_parent.add(Panel_child, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 441, -1, 660));
        ...
        panel_parent.add(Reciept1, new org.netbeans.lib.awtextra.AbsoluteConstraints(900, 120, -1, -1));

        text_student.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        text_student.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                text_studentMouseEntered(evt);
            }
        });
        ...
        text_student.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                text_studentKeyPressed(evt);
            }
            public void keyReleased(java.awt.event.KeyEvent evt) {
                text_studentKeyReleased(evt);
            }
            public void keyTyped(java.awt.event.KeyEvent evt) {
                text_studentKeyTyped(evt);
            }
        });
        panel_parent.add(text_student, new org.netbeans.lib.awtextra.AbsoluteConstraints(1080, 170, 270, -1));

        text_courseyear.setEditable(false);
        text_courseyear.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        panel_parent.add(text_courseyear, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 300, 190, -1));
        ...
        panel_parent.add(lbl_transactionid, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 400, -1, -1));

        text_chequeno.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        panel_parent.add(text_chequeno, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 400, 280, -1));

        text_cardno.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        panel_parent.add(text_cardno, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 400, 280, -1));
        ...
        panel_parent.add(text_transactionid, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 400, 280, -1));

        text_date.setEditable(false);
        text_date.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        panel_parent.add(text_date, new org.netbeans.lib.awtextra.AbsoluteConstraints(1080, 110, 200, -1));
        ...
        panel_parent.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(900, 240, -1, 210));

        panel_parent.add(combo_course, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 250, 170, 30));
        panel_parent.add(jSeparator5, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 70, 1420, 10));

        jLabel3.setFont(new java.awt.Font("Georgia", 1, 42)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("Add Fees");
        panel_parent.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 10, -1, -1));

        getContentPane().add(panel_parent, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 0, 1470, 1100));

        setSize(new java.awt.Dimension(1973, 1113));
    ...
    private void btn_submitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_submitActionPerformed
        ...
        if (i == 0) {
            ...
            try {
                ...
                Logger.getLogger(Add_fees.class
    ...
    private void text_studentKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_text_studentKeyTyped

    }//GEN-LAST:event_text_studentKeyTyped

    private void text_studentMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_text_studentMouseEntered
        // TODO add your handling code here:
    }//GEN-LAST:event_text_studentMouseEntered
    ...
    private void text_studentKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_text_studentKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_text_studentKeyPressed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Add_fees.class
    ...
    private javax.swing.JLabel Reciept11;
    ...
    private javax.swing.JLabel Reciept3;
