...
public class Search_record extends javax.swing.JFrame {
    ...
    /**
     * Creates new form All_Records
     */
    String receipt_no, student_name, rollno, course, payment, amount, remark;
    ...
    public void setTableRecords() {
        try {
            ...
            while (rs.next()) {
                ...
                Object[] obj = {receipt_no, student_name, rollno, payment, amount, remark};
                Model = (DefaultTableModel) table_records.getModel();
                Model.addRow(obj);
            }
    ...
    public void searchRecord(String s) {
        Model = (DefaultTableModel) table_records.getModel();
    ...
    private void initComponents() {
        ...
        jPanel2.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 110, -1, -1));
        ...
        table_records.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Receipt No.", "Student Name", "Enrollment No.", "Payment Mode", "Amount", "Remark"
            }
        ) {
        ...
        jPanel2.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 194, 1470, 930));
        ...
        jPanel2.add(text_search, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 110, 387, 41));
        jPanel2.add(jSeparator3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 78, 1400, -1));
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 0, 1470, 1066));
    ...
    private void ReloadMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ReloadMouseClicked
        Search_record e = new Search_record();
        e.show();
        this.dispose();        // TODO add your handling code here:
    ...
    private void text_searchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_text_searchActionPerformed
        ...
        String search = s.substring(0, 1).toUpperCase() + s.substring(1);
        searchRecord(search);
